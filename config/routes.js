...
module.exports = function(server){
  ...
  server.get({path: '/users/:id', version: config.app.version}, checkScopes(['users:list']), controllers.user.getUser);
  server.post({path: '/users/', version: config.app.version}, checkScopes(['users:create']), controllers.user.createUser);
  server.put({path: '/users/:id', version: config.app.version}, checkScopes(['users:edit']), controllers.user.updateUser);
  ...
  server.get({path: '/roles/:id', version: config.app.version}, checkScopes(['roles:list']), controllers.role.getRole);
  ...
  server.get({path: '/permissions/:id', version: config.app.version}, checkScopes(['permissions:list']), controllers.permission.getPermission);
